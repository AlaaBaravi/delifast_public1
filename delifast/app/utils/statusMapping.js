 ...
 * Maps Delifast status codes to simplified statuses and Shopify tags
 */
...
/**
 * Map of simplified status to Shopify tags and UI properties
 */
...
/**
 * Get status badge tone for Polaris
 * @param {string} status - Simplified status
 * @returns {string} Polaris tone
 */
export function getStatusTone(status) {
  return shopifyStatusMap[status]?.tone || 'info';
}
